...
?>
                                            ...
                                            @foreach ($sub as $item)
                                              <tr>
                                                  ...
                                                  <td class="cell">
                                                        <a  class="btn btn-primary" href="{{route('editpay',$item->id)}}"> <i class="fas fa-edit fa-1x"></i>
                                                         </a>
                                                        
                                                     <a href="{{route('deletepay',$item->id)}}" onclick="return confirm('you want to delete?');" class="btn btn-danger"><i class="fas fa-trash-alt"></i>
                                                    </a>
