                                ...
                                <div class="modal fade" id="exampleModal" tabindex="-1"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <form action="{{ route('store_classbase') }}" method="POST">
                                                    @csrf
                                                    <div class="mb-3">
...
?>
                                            @foreach ($class as $data)
                                                ...
                                                <tr>
                                                    <td class="cell"><span
                                                        class="truncate">{{ ++$i }}</span></td>
                                                 
                                                    <td class="cell"><span
                                                            class="truncate">{{ $data->class_name}}</span></td>
                                                            <td class="cell"><span
                                                                class="truncate">
                                                            <a href="{{ route('classbasedelete', $data->id) }}"
